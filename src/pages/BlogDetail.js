...
function BlogDetail() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // 5 related blogs excluding current
        const relBlogs = blogs
          .filter(
            (b) =>
              b.slug !== slug && String(b.id || b._id || "") !== slug
          )
          .slice(0, 5);
        setRelatedBlogs(relBlogs);

        // ---- Normalize news (for “Related News”) ----
        const news = (Array.isArray(newsRes.data) ? newsRes.data : []).map(
          (item) => {
            const computedSlug = item.slug || String(item.id || item._id || "");
            return {
              ...item,
        ...
        // Just show the latest/top 5 news (no special exclusion needed)
      ...
      <div className="Padding-Top">
        <div className="container">
          <div className="text-center py-5">
            ...
            <h4 className="mt-3">Loading Blog...</h4>
            <p className="text-muted">
              Please wait while we fetch the blog post for you.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="Padding-Top">
        <div className="container">
          <div className="text-center py-5">
            ...
            <h4 className="text-danger">Error Loading Blog</h4>
      ...
      <div className="Padding-Top">
        <div className="container">
          <div className="text-center py-5">
            ...
            <h4 className="text-warning">Blog Not Found</h4>
            <p className="text-muted">
  ...
  return (
    <>
      <Helmet>
        <title>{blog?.seoTitle || blog?.title || "Blog - HS India"}</title>
        <meta
          name="description"
          content={
            blog?.seoDescription ||
            "Read our latest blog posts about Indian fashion, culture, and heritage."
          }
        />
        <meta
          property="og:title"
          content={blog?.seoTitle || blog?.title || "Blog - HS India"}
        />
        <meta
        ...
        <div className="container">
          <div className="newsdetail-wrapper">
            ...
            <header className="newsdetail-hero">
              <h1 className="newsdetail-title">{blog.title}</h1>
              ...
              <div className="share-row">
                ...
                >
                  <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" width="30" height="30">
                    <path d="M22 12.06C22 6.48 17.52 2 11.94 2 6.36 2 1.88 6.48 1.88 12.06c0 4.99 3.64 9.14 8.4 9.94v-7.03H7.9v-2.91h2.38V9.41c0-2.35 1.4-3.65 3.55-3.65 1.03 0 2.1.18 2.1.18v2.31h-1.18c-1.16 0-1.52.72-1.52 1.47v1.77h2.59l-.41 2.91h-2.18V22c4.76-.79 8.4-4.94 8.4-9.94Z"/>
                  </svg>
                </a>
                <a
                ...
                >
                  <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" width="30" height="30">
                    <path d="M17.53 3H20l-5.34 6.1L21 21h-5.5l-4.3-5.62L6 21H3.53l5.74-6.56L3 3h5.6l3.9 5.2L17.53 3Zm-1.93 16.29h1.5L8.46 4.64H6.86l8.74 14.65Z"/>
                  </svg>
                </a>
                <a
                ...
                >
                  <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" width="30" height="30">
                    <path d="M20.45 20.45h-3.55v-5.6c0-1.33-.02-3.05-1.86-3.05-1.86 0-2.14 1.45-2.14 2.95v5.7H9.35V9h3.41v1.56h.05c.47-.88 1.63-1.8 3.36-1.8 3.6 0 4.27 2.37 4.27 5.45v6.24ZM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12ZM3.57 20.45h3.55V9H3.57v11.45ZM22 2H2v20h20V2Z"/>
                  </svg>
                </a>
                <a
